...
class View():
    def __init__(self, master):
        ...
        self.wc_predictor = Tk.Button(self.frame, text="World Cup 2018 Predictor")
        self.bl_predictor = Tk.Button(self.frame, text="Bundesliga 2017/2018 Predictor")
        self.wc_predictor.pack(side="top",fill=Tk.BOTH)
        self.bl_predictor.pack(side="top",fill=Tk.BOTH)
