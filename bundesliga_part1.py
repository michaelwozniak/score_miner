# TABLE WITH RESULTS FROM AUTUMN ROUND WITH ALL PREDICTED RESULTS FROM SPRING ROUND
...
def bundes1():
    ...
    # read all matches in 2018 from season 17/18
    ...
    after_merge_home_score = pd.merge(home_score, results, on="HomeTeam", how="inner")
    ...
    # spring_table and autumn_table with same headers
    spring_table.columns.values[1] = "Points"
    spring_table.columns.values[2] = "Goals for"
    spring_table.columns.values[3] = "Goals against"
    ...
    # quantity of matches
    final_predicted_table["Matches"] = "34"
    ...
    def bundesliga_table_1(data, col_width=1.0, row_height=0.625, font_size=10,
    ...
    bundesliga_table_1(final_predicted_table, header_columns=0, col_width=1.4)

    plt.savefig('media/bundes1.png')
